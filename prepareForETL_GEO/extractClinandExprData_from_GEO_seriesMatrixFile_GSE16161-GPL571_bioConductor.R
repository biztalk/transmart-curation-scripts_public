...
geo_id <-paste(geo_id, "-GPL571",sep="")
...
gse <- gseList$`GSE16161-GPL571_series_matrix.txt.gz`
...
#change source from leasional to lesional
levels(pdSubset$source) <- ("Lesional")
...
#replace NA with null so that transMart identifies scorad as numeric collection
